(function () {
  ...
  window.galleryItems = [
    // ── Layout ──────────────────────────────────────────
    {
      ...
      notes: "Stats + action",
      code:
        '<div class="stack"><div class="row between"><div><div class="strong">Welcome back, Hugo</div><div class="text">Compact workspace overview</div></div>' +
        button("Start", "plus", "primary") +
        '</div><div class="stat-grid"><div class="stat"><strong>12</strong><span class="tiny">Projects</span></div><div class="stat"><strong>4</strong><span class="tiny">Tasks</span></div><div class="stat"><strong>8</strong><span class="tiny">Messages</span></div></div></div>',
    },
    {
      name: "Setup pair",
      group: "Layout",
      ...
      code:
        '<div class="grid2"><div class="stack"><div class="strong">Welcome back</div><div class="text">Resume work or finish setup.</div><div class="row">' +
        button("New", "plus", "primary") +
        button("Docs", "book-open") +
        '</div></div><div class="sidebox"><div class="row between"><strong class="tiny">Setup</strong>' +
        icon("chevron-right") +
        '</div><div class="text">Profile, data, team.</div></div></div>',
    },
    {
      name: "Compact card",
      group: "Layout",
      notes: "Simple object",
      code:
        '<div class="stack"><div class="row between"><strong class="strong">Project Alpha</strong>' +
        chip("Active", "blue") +
        '</div><div class="text">Last edited today</div></div>',
    },
    {
      name: "Kanban mini",
      group: "Layout",
    ...
    },
    {
      ...
      notes: "Nav + content",
      code:
        '<div class="row" style="align-items:stretch"><div class="stack" style="width:52px;flex:none;padding:4px;border:1px solid var(--line);border-radius:5px;align-items:center">' +
        icon("layout-dashboard") +
        icon("list-todo") +
        icon("settings") +
        '</div><div class="stack" style="flex:1"><div class="strong">Dashboard</div><div class="text">Your workspace overview with compact metrics.</div></div></div>',
    },
    {
      name: "Header bar",
      group: "Layout",
      notes: "Top app bar",
      code:
        '<div class="row between" style="padding:4px 0"><div class="row"><strong class="strong">Tasktok</strong><span class="v-divider"></span><span class="text">Overview</span></div><div class="row">' +
        icon("bell") +
        '<div class="avatar" style="width:18px;height:18px;font-size:8px">HB</div></div></div>',
    },
    ...
    // ── Forms ──────────────────────────────────────────
    {
      ...
      notes: "Stacked auth",
      code:
        '<div class="stack"><input class="input" placeholder="Email"><input class="input" placeholder="Password" type="password"><div class="row between"><label class="row text"><input type="checkbox"> Remember</label><button class="btn ghost">Forgot?</button></div>' +
        button("Sign in", "log-in", "primary") +
        button("Create account", "user-plus") +
        "</div>",
    },
    {
      name: "Inline comment",
      ...
      code:
        '<div class="row"><textarea class="textarea" placeholder="Write a comment..."></textarea>' +
    ...
    },
    {
      ...
      notes: "Input + action",
      code:
        '<div class="row"><input class="input" placeholder="Search actions, pages, users...">' +
        button("Go", "search", "primary") +
        "</div>",
    },
    {
      name: "Invite user",
      ...
      notes: "Email capture",
      code:
        '<div class="row"><input class="input" placeholder="Invite by email">' +
        button("Invite", "user-plus", "primary") +
        "</div>",
    },
    {
      name: "Search filter",
      ...
      notes: "Input + filter",
      code:
        '<div class="row between"><div class="row"><input class="input" placeholder="Search..."><button class="btn">Active</button></div>' +
        button("Filter", "sliders-horizontal") +
        "</div>",
    },
    {
      name: "Two fields",
    ...
    },
    {
      ...
      notes: "Select + apply",
      code:
        '<div class="row"><select class="select"><option>Default</option></select>' +
        button("Apply") +
        "</div>",
    },
    {
      ...
      notes: "Drop target",
      code:
        '<div class="stack" style="place-items:center;text-align:center">' +
        chip("Upload", "blue") +
        '<div class="strong">Drop files here</div><div class="text">Assets or documents</div>' +
        button("Browse", "folder-open") +
        "</div>",
    },
    {
      name: "Date range",
    ...
    },
    {
      ...
      notes: "URL field",
      code:
        '<div class="row"><input class="input" value="https://app.example/link">' +
        button("Copy", "copy") +
        "</div>",
    },
    {
    ...
    },
    {
      ...
      notes: "Inline search",
      code:
        '<div class="row"><button class="btn icon-only">' +
        icon("search") +
        '</button><input class="input" placeholder="Find record"></div>',
    },
    {
      name: "Amount input",
      group: "Forms",
    ...
    },
    {
      ...
      code:
        '<div class="row"><button class="btn icon-only" data-step="-1">' +
        icon("minus") +
        '</button><input class="input" value="3" data-step-value><button class="btn icon-only" data-step="1">' +
        icon("plus") +
        "</button></div>",
    },
    {
      ...
      notes: "Field action",
      code:
        '<div class="row"><input class="input" type="password" value="secret"><button class="btn icon-only" data-password-toggle>' +
        icon("eye") +
        "</button></div>",
    },
    {
      ...
      code:
        '<div class="stack"><input class="input" value="hugo@app"><div class="row">' +
        chip("Invalid", "red") +
        '<span class="text">Use a full email address</span></div></div>',
    },
    {
      name: "Radio group",
      group: "Forms",
    ...
    },
    {
      ...
      code:
        '<div class="stack"><label class="row"><span class="check active">' +
        icon("check") +
        '</span><span class="text">Header</span></label><label class="row"><span class="check"></span><span class="text">Footer</span></label></div>',
    },
    {
      name: "Slider row",
      group: "Forms",
    ...
    },
    {
      ...
      code:
        ...
        chip("Admin") +
        chip("Clinic") +
        '<input class="input" placeholder="Add tag"></div>',
    },
    {
      name: "Color picker",
      group: "Forms",
    ...
    },
    {
      ...
      code:
        '<div class="row wrap"><select class="select" style="width:70px"><option>Status</option></select><select class="select" style="width:80px"><option>Priority</option></select><input class="input" style="width:80px" placeholder="Search">' +
        button("Clear") +
        "</div>",
    },
    {
    ...
    },
    {
      ...
      code:
        '<div class="row between"><label class="row"><input type="checkbox" checked><span class="text">3 selected</span></label><div class="row">' +
        button("Archive") +
        button("Delete", "trash-2", "danger") +
        "</div></div>",
    },
    ...
    },
    {
      ...
      code:
        '<div class="row wrap">' +
        chip("Status: Active", "blue") +
        chip("Priority: High") +
        chip("Team: Design") +
        '<button class="btn ghost">Clear all</button></div>',
    },
    ...
    // ── Data ──────────────────────────────────────────
    {
      ...
      notes: "Identity row",
      code:
        '<div class="row between"><div class="row"><div class="avatar">HB</div><div><div class="strong">Hugo Beyer</div><div class="text">Tech Artist</div></div></div>' +
        button("Open", "arrow-right") +
        "</div>",
    },
    {
      name: "Usage stats",
    ...
    },
    {
      ...
      notes: "Plan summary",
      code:
        '<div class="stack"><div class="row between"><span class="text">Plan</span><strong>Pro</strong></div><div class="row between"><span class="text">Usage</span><strong>72%</strong></div>' +
        button("Manage", "arrow-right", "primary") +
        "</div>",
    },
    {
      name: "Activity feed",
    ...
    },
    {
      ...
      notes: "Metric + delta",
      code:
        '<div class="row between"><div><div class="strong">$12,430</div><div class="text">Revenue</div></div>' +
        chip("+12%", "green") +
        "</div>",
    },
    {
    ...
    },
    {
      ...
      code:
        '<div class="stack">' +
        chip("Design review - 2PM") +
        chip("Client sync - Tomorrow") +
        chip("Launch - Friday") +
        "</div>",
    },
    {
      ...
      code:
        '<div class="stack"><div class="row between" style="padding:3px 0;border-bottom:1px solid var(--line)"><strong class="tiny">Name \u25B2</strong><strong class="tiny">Status</strong><strong class="tiny">Date</strong></div><div class="row between" style="padding:3px 0"><span class="text">API</span>' +
        chip("Live", "green") +
        '<span class="tiny">Now</span></div><div class="row between" style="padding:3px 0"><span class="text">Web</span>' +
        chip("Draft") +
        '<span class="tiny">1h</span></div></div>',
    },
    {
      name: "Status table",
      group: "Data",
    ...
    },
    {
      ...
      notes: "Member rows",
      code:
        '<div class="list"><div class="list-row"><div class="row"><div class="avatar" style="width:16px;height:16px;font-size:7px">AL</div><span class="text">Ana Lima</span></div>' +
        chip("Online", "green") +
        '</div><div class="list-row"><div class="row"><div class="avatar" style="width:16px;height:16px;font-size:7px">JS</div><span class="text">Joao Silva</span></div>' +
        chip("Away", "yellow") +
        '</div><div class="list-row"><div class="row"><div class="avatar" style="width:16px;height:16px;font-size:7px">MT</div><span class="text">Maria Torres</span></div>' +
        chip("Offline") +
        "</div></div>",
    },
    ...
    // ── Feedback ──────────────────────────────────────────
    {
      ...
      code:
        ...
        chip("Live", "green") +
        '<span class="text">API healthy</span></div>' +
        button("Check", "refresh-cw") +
        "</div>",
    },
    {
      name: "Notification",
      ...
      code:
        '<div class="row between"><div class="row">' +
        chip("Info", "blue") +
        '<span class="text">Deployment completed</span></div>' +
        button("Dismiss", "x", "ghost") +
        "</div>",
    },
    {
      name: "Progress",
    ...
    },
    {
      ...
      code:
        '<div class="stack" style="place-items:center;text-align:center">' +
        chip("Inbox") +
        '<div class="strong">No items yet</div><div class="text">Create your first item</div>' +
        button("Create", "plus", "primary") +
        "</div>",
    },
    {
      name: "Toast",
      ...
      code:
        '<div class="row between"><div class="row">' +
        chip("Saved", "green") +
        '<span class="text">Changes synced</span></div><button class="btn ghost">x</button></div>',
    },
    {
      name: "Danger confirm",
      group: "Feedback",
      ...
      code:
        '<div class="stack"><div class="strong">Delete item?</div><div class="text">This action cannot be undone.</div><div class="row">' +
        button("Delete", "trash-2", "danger") +
        button("Cancel") +
        "</div></div>",
    },
    {
      ...
      notes: "Release note",
      code:
        '<div class="stack"><div class="strong">New release</div><div class="text">Version 2.1 is now available.</div>' +
        button("Read notes", "arrow-right", "primary") +
        "</div>",
    },
    {
      name: "Skeleton rows",
    ...
    },
    {
      ...
      code:
        '<div class="row">' +
        icon("loader") +
        '<span class="text">Loading workspace...</span></div>',
    },
    {
      name: "Offline state",
      group: "Feedback",
      notes: "Status line",
      code:
        '<div class="row between"><span class="row">' +
        icon("wifi-off") +
        '<span class="text">Offline mode</span></span>' +
        chip("Local", "yellow") +
        "</div>",
    },
    {
      ...
      code:
        '<div class="callout">' +
        icon("clock") +
        '<span class="text">3 actions queued for sync.</span>' +
        button("View") +
        "</div>",
    },
    {
      ...
      code:
        ...
        icon("lock") +
        '<span class="text">You need admin access.</span></div>',
    },
    {
      name: "Inline help",
      group: "Feedback",
      ...
      code:
        '<div class="row">' +
        icon("circle-help") +
        '<span class="text">Use compact fields for dense panels.</span></div>',
    },
    {
      name: "Rating row",
      group: "Feedback",
    ...
    },
    {
      ...
      notes: "Yes/no prompt",
      code:
        '<div class="panel"><div class="strong">Confirm changes?</div><div class="text">This will update 12 records.</div><div class="row">' +
        button("Confirm", "check", "primary") +
        button("Cancel") +
        "</div></div>",
    },
    {
    ...
    },
    {
      ...
      code:
        ...
        icon("zap") +
        '<span class="text">You have used 85% of your plan.</span>' +
        button("Upgrade", "arrow-right", "primary") +
        "</div>",
    },
    {
      name: "Trial banner",
      ...
      notes: "Expiring soon",
      code:
        '<div class="row between" style="padding:4px 6px;background:#fffaeb;border-radius:5px"><span class="row">' +
        icon("clock") +
        '<span class="text">Trial ends in 3 days</span></span>' +
        button("Subscribe", "arrow-right", "primary") +
        "</div>",
    },
    {
      ...
      code:
        '<div class="row between"><div class="row">' +
        icon("wrench") +
        '<span class="text">Maintenance at 2AM UTC</span></div>' +
        chip("Scheduled", "yellow") +
        "</div>",
    },
    {
      name: "Empty inbox",
      ...
      code:
        '<div class="stack" style="place-items:center;text-align:center">' +
        icon("inbox") +
        '<div class="text">No new notifications</div><div class="tiny">You are all caught up!</div></div>',
    },
    ...
    },
    {
      ...
      code:
        '<div class="row between"><span class="text">Header</span>' +
        toggle(["Hide", "Show"], 1) +
        "</div>",
    },
    {
    ...
    },
    {
      ...
      code:
        ...
        chip("1", "blue") +
        '<span class="divider" style="flex:1"></span>' +
        chip("2") +
        '<span class="divider" style="flex:1"></span>' +
        chip("3") +
        "</div>",
    },
    {
      ...
      code:
        '<div class="row between">' +
        button("Prev") +
        '<span class="text">Page 1 of 8</span>' +
        button("Next") +
        "</div>",
    },
    {
    ...
    },
    {
      ...
      code:
        '<div class="row between"><span class="row">' +
        icon("search") +
        '<span class="text">Open command palette</span></span><span class="kbd">Ctrl K</span></div>',
    },
    {
      name: "Sidebar item",
      group: "Navigation",
      ...
      code:
        ...
        icon("layout-dashboard") +
        '<span class="text">Dashboard</span></div><div class="row">' +
        icon("list-todo") +
        '<span class="text">Tasks</span></div><div class="row">' +
        icon("settings") +
        '<span class="text">Settings</span></div></div>',
    },
    {
      ...
      code:
        '<div class="row between"><div class="seg"><button type="button">' +
        icon("chevron-left") +
        '</button><button class="active" type="button">1</button><button type="button">2</button><button type="button">' +
        icon("chevron-right") +
        '</button></div><span class="tiny">24 rows</span></div>',
    },
    {
      name: "Tab with count",
      group: "Navigation",
      ...
      code:
        '<div class="seg"><button class="active" type="button">Open ' +
        chip("8", "blue") +
        '</button><button type="button">Done ' +
        chip("21") +
        "</button></div>",
    },
    {
    ...
    },
    {
      ...
      notes: "Icons + labels",
      code:
        '<div class="tab-icon"><button class="act" type="button">' +
        icon("layout-dashboard") +
        'Overview</button><button type="button">' +
        icon("list-todo") +
        'Tasks</button><button type="button">' +
        icon("settings") +
        "</button></div>",
    },
    {
      ...
      notes: "Side stacked",
      code:
        '<div class="tab-v"><button class="act" type="button">' +
        icon("layout-dashboard") +
        'Dashboard</button><button type="button">' +
        icon("list-todo") +
        'Tasks</button><button type="button">' +
        icon("users") +
        "Team</button></div>",
    ...
    },
    {
      ...
      notes: "Grouped links",
      code:
        '<div class="stack"><div class="tiny" style="margin:2px 0">Main</div><div class="row">' +
        icon("layout-dashboard") +
        '<span class="text">Dashboard</span></div><div class="row">' +
        icon("list-todo") +
        '<span class="text">Tasks</span></div><div class="tiny" style="margin:2px 0">Account</div><div class="row">' +
        icon("settings") +
        '<span class="text">Settings</span></div></div>',
    },
    {
      ...
      code:
        '<div class="row between"><div class="row">' +
        chip("1", "blue") +
        '<span class="text">Profile</span></div>' +
        icon("chevron-right") +
        '<div class="row">' +
        chip("2") +
        '<span class="text">Team</span></div>' +
        icon("chevron-right") +
        '<div class="row">' +
        chip("3") +
        '<span class="text">Billing</span></div></div>',
    },
    {
      name: "Toggle view",
      group: "Navigation",
      notes: "Two states",
      code:
        '<div class="row between"><div class="seg"><button class="active" type="button">' +
        icon("list") +
        'List</button><button type="button">' +
        icon("grid") +
        'Grid</button></div><span class="tiny">Show all</span></div>',
    },
    {
      ...
      notes: "Full sidebar",
      code:
        '<div class="stack" style="background:#f8fafc;border-radius:5px;padding:6px;width:100%"><div class="tab-v"><button class="act" type="button">' +
        icon("layout-dashboard") +
        'Dashboard</button><button type="button">' +
        icon("list-todo") +
        'Tasks <span class="badge-count" style="margin-left:auto">3</span></button><button type="button">' +
        icon("users") +
        'Team</button><button type="button">' +
        icon("settings") +
    ...
    },
    {
      ...
      code:
        '<div class="row wrap"><button class="btn icon-only">' +
        icon("plus") +
        '</button><button class="btn icon-only">' +
        icon("settings") +
        '</button><button class="btn icon-only">' +
        icon("trash-2") +
        "</button></div>",
    ...
    },
    {
      ...
      code:
        '<div class="row">' +
        chip("Production", "dark") +
        '<span class="text">Stable channel</span></div>',
    },
    {
      name: "Text link",
      group: "Primitives",
    ...
    },
    {
      ...
      code:
        '<div class="row"><span class="check active">' +
        icon("check") +
        '</span><span class="text">Selected item</span></div>',
    },
    {
      name: "Radio visual",
      group: "Primitives",
    ...
    },
    {
      ...
      code:
        '<div class="row wrap">' +
        button("Normal") +
        button("Primary", "check", "primary") +
        '<button class="btn active" type="button">Active</button><button class="btn" disabled type="button">Disabled</button></div>',
    },
    {
      name: "Status dots",
      group: "Primitives",
    ...
    },
    {
      ...
      code:
        '<div class="row wrap"><span class="chip">' +
        icon("zap") +
        'Pro</span><span class="chip blue">' +
        icon("check") +
        'Verified</span><span class="chip green">' +
        icon("trending-up") +
        "Growing</span></div>",
    },
    {
      ...
      notes: "Dark icons",
      code:
        '<div class="row wrap" style="background:#1f2937;border-radius:5px;padding:4px"><button class="btn" style="background:transparent;border-color:transparent;color:#fff">' +
        icon("bold") +
        '</button><button class="btn" style="background:transparent;border-color:transparent;color:#fff">' +
        icon("italic") +
        '</button><button class="btn" style="background:transparent;border-color:transparent;color:#fff">' +
        icon("underline") +
        "</button></div>",
    ...
    },
    {
      ...
      notes: "Rows only",
      code:
        '<div class="list"><div class="list-row"><span class="row"><span class="check active">' +
        icon("check") +
        '</span><span class="text">Copy updated</span></span>' +
        chip("Done", "green") +
        '</div><div class="list-row"><span class="row"><span class="check"></span><span class="text">QA pass</span></span>' +
        chip("Todo") +
        "</div></div>",
    },
    {
      ...
      notes: "Avatar rows",
      code:
        '<div class="list"><div class="list-row"><span class="row"><span class="avatar">AL</span><span class="text">Ana Lima</span></span>' +
        chip("Owner", "blue") +
        '</div><div class="list-row"><span class="row"><span class="avatar">JS</span><span class="text">Joao Silva</span></span>' +
        chip("Editor") +
        "</div></div>",
    },
    {
      ...
      notes: "Icon rows",
      code:
        '<div class="list"><div class="list-row"><span class="row">' +
        icon("bell") +
        '<span class="text">New request</span></span><span class="tiny">2m</span></div><div class="list-row"><span class="row">' +
        icon("check") +
        '<span class="text">Build passed</span></span><span class="tiny">8m</span></div></div>',
    },
    {
      name: "Compact table",
      group: "Lists",
      ...
      code:
        '<div class="list"><div class="list-row"><strong class="tiny">Name</strong><strong class="tiny">State</strong></div><div class="list-row"><span class="text">API</span>' +
        chip("Live", "green") +
        '</div><div class="list-row"><span class="text">Billing</span>' +
        chip("Draft") +
        "</div></div>",
    },
    {
    ...
    },
    {
      ...
      code:
        ...
        icon("chevron-right") +
        icon("folder") +
        '<span class="text">src</span></div><div class="row" style="padding-left:18px">' +
        icon("file-text") +
        '<span class="text">index.ts</span></div><div class="row" style="padding-left:18px">' +
        icon("folder") +
        '<span class="text">components</span></div><div class="row" style="padding-left:36px">' +
        icon("file-text") +
        '<span class="text">Button.tsx</span></div></div>',
    },
    {
      name: "Accordion",
      group: "Lists",
      ...
      code:
        '<div class="stack"><div class="accordion-row"><div class="ah"><span class="strong">General settings</span>' +
        icon("chevron-down") +
        '</div><div class="ac">Language, timezone, region preferences.</div></div><div class="divider"></div><div class="accordion-row"><div class="ah"><span class="strong">Notifications</span>' +
        icon("chevron-right") +
        "</div></div></div>",
    },
    {
    ...
    // ── Surfaces ──────────────────────────────────────────
    {
      ...
      code:
        '<div class="panel"><div class="row between"><strong class="tiny">Workspace</strong>' +
        chip("Live", "green") +
        '</div><div class="text">A bounded surface with its own content.</div></div>',
    },
    {
      ...
      code:
        '<div class="panel"><div class="soft-row row between"><span class="text">Header</span>' +
        chip("Visible", "green") +
        '</div><div class="soft-row row between"><span class="text">Footer</span>' +
        chip("Hidden") +
        "</div></div>",
    },
    {
    ...
    },
    {
      ...
      code:
        '<div class="row between"><div><div class="strong">Project Alpha</div><div class="text">Updated today</div></div>' +
        chip("Active", "blue") +
        "</div>",
    },
    {
      ...
      code:
        '<div class="callout">' +
        icon("info") +
        '<span class="text">This setting applies to new widgets only.</span></div>',
    },
    {
      ...
      code:
        ...
        icon("check") +
        '<span class="text">Changes saved successfully.</span></div>',
    },
    {
      ...
      code:
        '<div class="callout warn">' +
        icon("triangle-alert") +
        '<span class="text">Billing limit almost reached.</span></div>',
    },
    {
      name: "Error callout",
      group: "Surfaces",
      ...
      code:
        '<div class="callout bad">' +
        icon("circle-alert") +
        '<span class="text">Sync failed. Retry required.</span></div>',
    },
    {
      ...
      code:
        '<div class="panel" style="background:#eff6ff;border-color:#b2ccff"><div class="strong">New: Dark mode</div><div class="text">Switch themes in settings.</div><div class="row">' +
        button("Try now", "sparkles", "primary") +
        "</div></div>",
    },
    ...
    },
    {
      ...
      notes: "SVG circle",
      code:
        '<div class="row between"><div class="ring"><svg width="30" height="30" viewBox="0 0 30 30"><circle class="bg" cx="15" cy="15" r="11"></circle><circle class="fg" cx="15" cy="15" r="11" stroke-dasharray="69.1" stroke-dashoffset="24.9"></circle></svg></div><div><div class="strong">64%</div><div class="text">Complete</div></div>' +
        chip("+8%", "green") +
        "</div>",
    },
    {
    ...
    // ── Calendars ──────────────────────────────────────────
    {
      ...
      notes: "Full 31-day",
      code:
        '<div class="stack"><div class="row between"><strong class="tiny">March 2025</strong>' +
        icon("chevron-right") +
        '</div><div class="month-grid"><span class="wd">S</span><span class="wd">M</span><span class="wd">T</span><span class="wd">W</span><span class="wd">T</span><span class="wd">F</span><span class="wd">S</span><span class="d other">23</span><span class="d other">24</span><span class="d other">25</span><span class="d other">26</span><span class="d other">27</span><span class="d other">28</span><span class="d">1</span><span class="d">2</span><span class="d">3</span><span class="d">4</span><span class="d">5</span><span class="d">6</span><span class="d">7</span><span class="d">8</span><span class="d">9</span><span class="d">10</span><span class="d">11</span><span class="d">12</span><span class="d today">13</span><span class="d">14</span><span class="d act">15</span><span class="d">16</span><span class="d">17</span><span class="d">18</span><span class="d">19</span><span class="d">20</span><span class="d">21</span><span class="d">22</span><span class="d">23</span><span class="d">24</span><span class="d">25</span><span class="d">26</span><span class="d">27</span><span class="d">28</span><span class="d">29</span><span class="d">30</span><span class="d">31</span></div></div>',
    },
    {
      name: "Week view",
      group: "Calendars",
      notes: "7-column",
      code:
        '<div class="stack"><div class="row between"><strong class="tiny">Mon 10 - Sun 16</strong>' +
        icon("chevron-right") +
        '</div><div class="week-view"><span class="wh"></span><span class="wh">M</span><span class="wh">T</span><span class="wh">W</span><span class="wh">T</span><span class="wh">F</span><span class="wh">S</span><span class="wh">S</span><span class="wt">9a</span><span class="wc"></span><span class="wc"></span><span class="wc hl">Standup</span><span class="wc"></span><span class="wc"></span><span class="wc"></span><span class="wc"></span><span class="wt">10a</span><span class="wc"></span><span class="wc"></span><span class="wc hl">Review</span><span class="wc"></span><span class="wc"></span><span class="wc"></span><span class="wc"></span><span class="wt">11a</span><span class="wc"></span><span class="wc"></span><span class="wc"></span><span class="wc"></span><span class="wc"></span><span class="wc hl">Sync</span><span class="wc"></span></div></div>',
    },
    {
      name: "Day agenda",
      group: "Calendars",
    ...
    // ── Card Groups ──────────────────────────────────────────
    {
      ...
      notes: "Avatar cards",
      code:
        '<div class="card-grid"><div class="info-card"><div class="row"><div class="avatar" style="width:18px;height:18px;font-size:8px">HB</div><div><div class="strong tiny">Hugo Beyer</div><div class="tiny">Design</div></div></div>' +
        chip("Online", "green") +
        '</div><div class="info-card"><div class="row"><div class="avatar" style="width:18px;height:18px;font-size:8px">AL</div><div><div class="strong tiny">Ana Lima</div><div class="tiny">Dev</div></div></div>' +
        chip("Away", "yellow") +
        '</div><div class="info-card"><div class="row"><div class="avatar" style="width:18px;height:18px;font-size:8px">JS</div><div><div class="strong tiny">Joao Silva</div><div class="tiny">QA</div></div></div>' +
        chip("Offline") +
        '</div><div class="info-card"><div class="row"><div class="avatar" style="width:18px;height:18px;font-size:8px">MT</div><div><div class="strong tiny">Maria Torres</div><div class="tiny">PM</div></div></div><span class="switch active"><span></span></span></div></div>',
    },
    {
      name: "Project cards",
      group: "Card Groups",
      notes: "Status grid",
      code:
        '<div class="card-grid"><div class="info-card"><div class="row between"><span class="strong">Alpha</span>' +
        chip("Live", "green") +
        '</div><div class="text">Landing page redesign</div><div class="row"><span class="tiny">Due Fri</span></div></div><div class="info-card"><div class="row between"><span class="strong">Beta</span>' +
        chip("Draft") +
        '</div><div class="text">Analytics dashboard</div><div class="row"><span class="tiny">Due Mon</span></div></div></div>',
    },
    {
      name: "Metric cards",
      group: "Card Groups",
      notes: "KPI grid",
      code:
        '<div class="card-grid"><div class="info-card"><div class="strong">$12,430</div><div class="row between"><span class="text">Revenue</span>' +
        chip("+12%", "green") +
        '</div></div><div class="info-card"><div class="strong">245</div><div class="row between"><span class="text">Users</span>' +
        chip("+8%", "green") +
        '</div></div><div class="info-card"><div class="strong">89%</div><div class="row between"><span class="text">Retention</span>' +
        chip("+3%", "green") +
        '</div></div><div class="info-card"><div class="strong">32</div><div class="row between"><span class="text">Active</span>' +
        chip("-2%", "red") +
        "</div></div></div>",
    },
    {
      ...
      notes: "3 columns",
      code:
        '<div class="grid3"><div class="info-card"><div class="strong">Starter</div><div class="strong">$12</div><div class="tiny">/mo</div><div class="text">Basic features</div>' +
        button("Choose") +
        '</div><div class="info-card" style="border-color:var(--primary)"><div class="row between"><div class="strong">Pro</div>' +
        chip("Popular", "blue") +
        '</div><div class="strong">$24</div><div class="tiny">/mo</div><div class="text">Full access</div>' +
        button("Subscribe", "arrow-right", "primary") +
        '</div><div class="info-card"><div class="strong">Enterprise</div><div class="strong">$48</div><div class="tiny">/mo</div><div class="text">Custom solutions</div>' +
        button("Contact") +
        "</div></div>",
    },
    {
      ...
      code:
        '<div class="card-grid"><div class="info-card"><div class="icn">' +
        icon("zap") +
        '</div><div class="strong">Fast</div><div class="text">Optimized performance</div></div><div class="info-card"><div class="icn">' +
        icon("shield") +
        '</div><div class="strong">Secure</div><div class="text">End-to-end encryption</div></div><div class="info-card"><div class="icn">' +
        icon("users") +
        '</div><div class="strong">Team</div><div class="text">Collaborative editing</div></div><div class="info-card"><div class="icn">' +
        icon("bar-chart") +
        '</div><div class="strong">Analytics</div><div class="text">Real-time insights</div></div></div>',
    },
    {
      name: "Plan compare",
      group: "Card Groups",
      notes: "Side by side",
      code:
        '<div class="grid2"><div class="info-card"><div class="strong tiny">Free</div><div class="row between"><span class="text">Projects</span><span class="tiny">3</span></div><div class="row between"><span class="text">Storage</span><span class="tiny">1 GB</span></div><div class="row between"><span class="text">Team</span><span class="tiny">1</span></div>' +
        button("Current", "check", "primary") +
        '</div><div class="info-card" style="border-color:var(--primary)"><div class="strong tiny">Pro <span class="badge-count" style="margin-left:4px">Save 20%</span></div><div class="row between"><span class="text">Projects</span><span class="tiny">Unlimited</span></div><div class="row between"><span class="text">Storage</span><span class="tiny">50 GB</span></div><div class="row between"><span class="text">Team</span><span class="tiny">10</span></div>' +
        button("Upgrade", "arrow-right", "primary") +
        "</div></div>",
    },
    {
      ...
      notes: "Single card",
      code:
        '<div class="info-card"><div class="row"><div class="avatar">HB</div><div><div class="strong">Hugo Beyer</div><div class="text">hugo@tasktok.io</div></div></div><div class="row between"><span class="row">' +
        chip("Design", "blue") +
        chip("Pro") +
        "</span>" +
        button("View", "arrow-right") +
        "</div></div>",
    },
    {
    ...
    },
    {
      ...
      code:
        '<div class="card-grid"><div class="info-card"><div class="row"><div class="icn">' +
        icon("code") +
        '</div><div><div class="strong">GitHub</div><div class="tiny">Connected</div></div></div>' +
        chip("Sync", "green") +
        '</div><div class="info-card"><div class="row"><div class="icn">' +
        icon("message-square") +
        '</div><div><div class="strong">Slack</div><div class="tiny">Disconnected</div></div></div>' +
        button("Connect") +
        "</div></div>",
    },
    {
    ...
    },
    {
      ...
      notes: "File cards",
      code:
        '<div class="card-grid"><div class="info-card"><div class="row"><div class="thumbnail" style="width:24px;height:24px">' +
        icon("file-text") +
        '</div><div><div class="strong tiny">Report Q1</div><div class="tiny">2.4 MB</div></div></div></div><div class="info-card"><div class="row"><div class="thumbnail" style="width:24px;height:24px;background:linear-gradient(135deg,#fef3f2,#fff)">' +
        icon("image") +
        '</div><div><div class="strong tiny">hero.png</div><div class="tiny">1.8 MB</div></div></div></div></div>',
    },
    {
      name: "Pipeline cards",
      group: "Card Groups",
    ...
    },
    {
      ...
      notes: "Mini dash",
      code:
        '<div class="card-grid"><div class="info-card"><div class="row between"><span class="strong">$12k</span>' +
        chip("+14%", "green") +
        '</div><div class="tiny">Revenue</div><div class="spark" style="height:16px"><span style="height:30%"></span><span style="height:46%"></span><span style="height:62%"></span><span style="height:80%"></span></div></div><div class="info-card"><div class="row between"><span class="strong">245</span>' +
        chip("+8%", "green") +
        '</div><div class="tiny">Users</div><div class="spark" style="height:16px"><span style="height:40%"></span><span style="height:55%"></span><span style="height:48%"></span><span style="height:72%"></span></div></div></div>',
    },
    ...
    // ── Media ──────────────────────────────────────────
    {
      ...
      code:
        '<div class="row between"><span class="row">' +
        icon("file-text") +
        '<span class="text">contract.pdf</span></span><span class="tiny">2.4 MB</span></div>',
    },
    {
      ...
      code:
        ...
        icon("image") +
        '</div><div><div class="strong">hero.png</div><div class="text">1200 x 800</div></div></div>',
    },
    {
      ...
      code:
        '<div class="dropzone">' +
        icon("upload") +
        '<div class="strong">Drop image</div><div class="text">PNG, JPG, SVG</div></div>',
    },
    {
    ...
    },
    {
      ...
      code:
        '<div class="row between"><div class="row"><div class="thumbnail">' +
        icon("image") +
        '</div><span class="text">Background</span></div><div class="row">' +
        button("Crop", "crop") +
        button("Remove", "trash-2", "danger") +
        "</div></div>",
    },
    {
      name: "Gallery grid",
      ...
      notes: "Image grid",
      code:
        '<div class="grid3"><div class="thumbnail" style="height:28px">' +
        icon("image") +
        '</div><div class="thumbnail" style="height:28px;background:linear-gradient(135deg,#fef3f2,#ecfdf3)">' +
        icon("image") +
        '</div><div class="thumbnail" style="height:28px;background:linear-gradient(135deg,#fffaeb,#f3e8ff)">' +
        icon("image") +
        "</div></div>",
    },
    {
      ...
      notes: "Dot nav",
      code:
        '<div class="stack"><div class="thumbnail" style="height:30px">' +
        icon("image") +
        '</div><div class="row" style="justify-content:center"><span class="tag-dot" style="background:var(--primary);width:5px;height:5px"></span><span class="tag-dot" style="width:5px;height:5px"></span><span class="tag-dot" style="width:5px;height:5px"></span></div></div>',
    },
    {
      name: "Video embed",
      group: "Media",
      notes: "Play overlay",
      code:
        '<div class="thumbnail" style="height:32px;background:#111827;color:#fff">' +
        icon("play") +
        ' <span class="tiny">Intro video</span></div>',
    },
    ...
    // ── Overlays ──────────────────────────────────────────
    {
      ...
      code:
        '<div class="panel"><div class="list"><div class="list-row"><span class="row">' +
        icon("copy") +
        '<span class="text">Duplicate</span></span></div><div class="list-row"><span class="row">' +
        icon("share-2") +
        '<span class="text">Share</span></span></div><div class="list-row"><span class="row">' +
        icon("trash-2") +
        '<span class="text">Delete</span></span></div></div></div>',
    },
    {
      name: "Popover header",
      group: "Overlays",
      notes: "Panel surface",
      code:
        '<div class="panel"><div class="row between"><strong class="tiny">Widget settings</strong>' +
        button("Done", "check", "primary") +
        '</div><div class="text">Choose visibility and layout.</div></div>',
    },
    {
      name: "Tooltip sample",
      group: "Overlays",
      ...
      code:
        '<div class="row"><button class="btn icon-only">' +
        icon("info") +
        '</button><span class="chip dark">This is a tooltip</span></div>',
    },
    {
      name: "Modal footer",
      group: "Overlays",
      notes: "Actions only",
      code:
        '<div class="row between"><button class="btn">Cancel</button>' +
        button("Confirm", "check", "primary") +
        "</div>",
    },
    {
      ...
      notes: "Menu commands",
      code:
        '<div class="panel"><div class="stack"><button class="btn ghost">' +
        icon("settings") +
        'Configure</button><button class="btn ghost">' +
        icon("copy") +
        'Duplicate</button><button class="btn ghost danger">' +
        icon("trash-2") +
    ...
    },
    {
      ...
      notes: "Side slide",
      code:
        '<div class="stack" style="border:1px solid var(--line);border-radius:5px;padding:7px"><div class="row between"><strong class="tiny">Notifications</strong><button class="btn ghost">' +
        icon("x") +
        '</button></div><div class="text">New comment on your post</div><div class="text">Build completed</div></div>',
    },
    {
      name: "Side panel",
      group: "Overlays",
      notes: "Detail panel",
      code:
        '<div class="panel"><div class="row between"><strong class="tiny">Task details</strong>' +
        icon("x") +
        '</div><div class="divider"></div><div class="text">Review analytics dashboard mockups. Due tomorrow.</div><div class="row">' +
        chip("Design", "blue") +
        chip("High", "red") +
        "</div></div>",
    },
    {
      ...
      code:
        ...
        icon("circle-help") +
        '<strong class="tiny">Need help?</strong></div><div class="text">Search docs or contact support.</div><div class="row">' +
        button("Docs", "book-open") +
        button("Chat", "message-circle", "primary") +
        "</div></div>",
    },
    {
      name: "Search panel",
      ...
      code:
        '<div class="panel"><div class="row" style="border-bottom:1px solid var(--line);padding-bottom:4px">' +
        icon("search") +
        '<input class="input" placeholder="Type a command..." style="border:none;background:transparent;padding:0 4px"></div><div class="list"><div class="list-row"><span class="row">' +
        icon("layout-dashboard") +
        '<span class="text">Go to Dashboard</span></span><span class="kbd">Ctrl 1</span></div><div class="list-row"><span class="row">' +
        icon("settings") +
        '<span class="text">Open Settings</span></span><span class="kbd">Ctrl ,</span></div></div></div>',
    },
    {
      name: "Share dialog",
      group: "Overlays",
      notes: "Share panel",
      code:
        '<div class="panel"><div class="strong tiny">Share project</div><input class="input" value="https://tasktok.io/share/abc123"><div class="row">' +
        button("Copy link", "copy") +
        button("Share", "share-2", "primary") +
        "</div></div>",
    },
    ...
    },
    {
      ...
      notes: "Service row",
      code:
        '<div class="row between"><span class="row"><span class="tag-dot"></span><span class="text">GET /tasks</span></span>' +
        chip("200", "green") +
        "</div>",
    },
    {
    ...
    },
    {
      ...
      notes: "Endpoint row",
      code:
        '<div class="row between"><div class="stack"><span class="code-line" style="font-size:9px">https://api.tasktok.io/hooks/abc</span><span class="tiny">Last triggered 2m ago</span></div>' +
        button("Test", "play") +
        "</div>",
    },
    {
  ...
  function renderThemeToggles() {
    if (!els.themeToggles) return;
    var current = window.__galleryTheme || "clean";
    els.themeToggles.innerHTML = themes
      .map(function (t) {
        return (
  ...
  function groups() {
    return ["All"].concat(
      Array.from(
        new Set(
          window.galleryItems.map(function (item) {
            return item.group;
          }),
        ),
      ).sort(),
  ...
  function filteredItems() {
    ...
    return window.galleryItems.filter(function (item) {
  ...
  function renderGallery() {
    ...
    els.gallery.innerHTML = items.map(renderCard).join("");
    hydrateInteractive(els.gallery);
  }
  ...
  function bind() {
    document.addEventListener("click", function (event) {
      ...
      if (copyButton) {
        var item = filteredItems()[Number(copyButton.dataset.copy)];
        if (item) copyText(item.code, copyButton);
        return;
      }

      var dismissButton = event.target.closest("[data-dismiss]");
      if (dismissButton) {
        dismissFrom(dismissButton);
        return;
      }

      if (event.target.closest("#copyAll")) {
        var text = filteredItems()
          .map(function (item) {
            return (
  ...
  function runTests() {
    ...
    console.assert(
      document.querySelectorAll("svg.lucide").length > 0,
      "lucide icons render",
    );
  }
